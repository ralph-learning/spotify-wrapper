...
[![Coverage Status](https://coveralls.io/repos/github/ralph-learning/spotify-wrapper/badge.svg?branch=master)](https://coveralls.io/github/ralph-learning/spotify-wrapper?branch=master)
...
Please read [CONTRIBUTING.md](https://github.com/ralph-learning/spotify-wrapper/blob/master/CONTRIBUTING.md) for details on our code of conduct, and the process for submitting pull requests to us.
...
See also the list of [contributors](https://github.com/ralph-learning/spotify-wrapper/graphs/contributors) who participated in this project.
